...
<body id="portada">
        ...
        <div class="menu">
            <nav>
                <ul>
                    ...
                    <li class="li_barra"><a class="barra active" href="comedores.php">Comedores</a></li>
    ...
    <div class="flex" id="flex">
        ...
        <div class="div_botones" id="div_botones">
            <div>
                <h2>COMEDOR GOURMET</h2>

                <?php

                    $sql = "SELECT * FROM tbl_mesa where lugar_mesa='Comedor Gourmet'";
            ...
            <br>
            <div>
                <h2>COMEDOR DELUXE</h2>

                <?php

                    $sql = "SELECT * FROM tbl_mesa where lugar_mesa='Comedor Deluxe'";
            ...
            <br>
            <div>
                <h2>COMEDOR PRINCIPAL</h2>

                <?php

                    $sql = "SELECT * FROM tbl_mesa where lugar_mesa='Comedor Principal'";

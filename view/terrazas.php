...
<body id="portada">
    ...
    <div class="flex">
        <div class="menu">
            <nav>
                <ul>
                    <li class="li_barra"><a class="barra active" href="terrazas.php">Terrazas</a></li>
    ...
    <div class="flex" id="flex">
        ...
        <div class="div_botones" id="div_botones">
            ...
            <h2>TERRAZA NORTE</h2>
                ...
                <?php
                    $sql = "SELECT * FROM tbl_mesa where lugar_mesa='Terraza Norte'";
                    ...
                    $results = $sentencia -> fetchAll(PDO::FETCH_OBJ);
                        ...
                        ?>
                            <form action="../processes/reserva.php" method="POST" >
            ...
            <?php
                ...
                $sql = "SELECT * FROM tbl_mesa where lugar_mesa='Terraza Sur'";
            ...
            <?php
                ...
                $sql = "SELECT * FROM tbl_mesa where lugar_mesa='Terraza Oeste'";
